...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private com.decard.mobilesdkexample.LoginRegister.DBOpenHelper mDBOpenHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDBOpenHelper = new com.decard.mobilesdkexample.LoginRegister.DBOpenHelper(this);

        //将验证码用图片的形式显示出来
        mIvRegisteractivityShowcode.setImageBitmap(com.decard.mobilesdkexample.LoginRegister.Code.getInstance().createBitmap());
        realCode = com.decard.mobilesdkexample.LoginRegister.Code.getInstance().getCode().toLowerCase();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_registeractivity_back: //返回登录页面
                Intent intent1 = new Intent(this, com.decard.mobilesdkexample.LoginRegister.loginActivity.class);
                ...
                if (!TextUtils.isEmpty(username) && !TextUtils.isEmpty(password1) && !TextUtils.isEmpty(password2) && !TextUtils.isEmpty(phoneCode)) {
                    if (!password1.equals(password2)) {
                        ...
                        if (phoneCode.equals(realCode)) {
                            ...
                            Intent intent2 = new Intent(this, com.decard.mobilesdkexample.LoginRegister.loginActivity.class);
